...
> = {
  ...
  systemPrompt(ctx) {
    return [
      ...
      "",
      "Always produce a complete `SceneEmotionalState` with all ten fields:",
      "  emotionalEntryState, emotionalExitState, hiddenWant, visibleWant,",
      "  fear, contradiction, subtext, behavioralTells, powerShift,",
      "  relationshipShift.",
      "",
      "Also produce a `truthScore` from 0..1 — be honest, not nice. A scene",
      "where characters explain their feelings instead of dramatizing them",
